// Script to seed training resources into Supabase
import { createClient } from '@supabase/supabase-js';

const supabaseUrl = process.env.VITE_SUPABASE_URL || 'https://zfssmltwsfyedqzaikkf.supabase.co';
...
const trainingResources = [
    {
        title: 'Vision et Positionnement Nexus',
        category: 'sales_arguments',
        excerpt: "Comprendre le contexte de la digitalisation et l'ADN Nexus pour convaincre efficacement.",
        content: `# Vision, Positionnement et Philosophie Nexus
...
**Chaque entreprise sans site web, ou avec un site obsolète, est un prospect qualifié.**`,
    ...
    },
    {
        ...
        excerpt: "Maîtrisez le langage du web pour crédibiliser votre discours face au client.",
        content: `# Vulgarisation Technique et Éducation Numérique
...
**L'abonnement Nexus est une "assurance tranquillité"** incluant la sécurité, les sauvegardes et les mises à jour.`,
    ...
    {
        title: 'Les Offres Site Vitrine',
        category: 'product_info',
        excerpt: "Analyse détaillée des trois formules Starter, Business et Premium avec argumentaires.",
        content: `# Analyse Détaillée des Offres "Site Vitrine"
...
> **Argumentaire :** "À ce niveau, votre site web est le reflet direct de la qualité de vos produits. Un design sur-mesure et des animations fluides envoient un signal de solidité financière et d'excellence."`,
    ...
    {
        title: "L'Automatisation : Levier de Rentabilité",
        category: 'product_info',
        excerpt: "Vendre l'automatisation comme une économie, pas comme un coût. Scénarios concrets et ROI.",
        content: `# L'Automatisation – Le Levier de Rentabilité Ultime
...
La réponse est souvent "la facturation", "le planning", ou "le téléphone". La réponse Nexus est : **"Nous avons un module pour ça."**`,
    ...
    },
    {
        ...
        category: 'product_info',
        excerpt: "Applications Web, Applications Mobiles et Identité Visuelle - L'étendue complète de la gamme Nexus.",
        content: `# Les Services Complémentaires
...
**Argument :** Une **"identité visuelle forte et unique"** crédibilise l'entreprise avant même qu'on lise ses textes.`,
    ...
    {
        title: 'Manuel de Vente et Objections',
        category: 'best_practices',
        excerpt: "Psychologie de vente, méthode SONCAS, ciblage et traitement des objections les plus courantes.",
        content: `# Le Manuel de Vente (Méthodologie et Psychologie)
...
- **La Réassurance :** "Rappelez-vous, vous validez chaque étape avec nous. Vous ne prenez aucun risque sur le résultat final."`,
    ...
    {
        title: 'Processus Client et Parcours Production',
        category: 'process',
        excerpt: "Le cycle de vie complet d'un projet Nexus, de la prise de contact à la maintenance.",
        content: `# Processus Client et Parcours de Production
...
> **Point clé à retenir :** Le client valide chaque étape majeure. Il ne découvre jamais le résultat à la fin, il le **construit avec nous**.`,
    ...
    },
    {
        ...
        category: 'best_practices',
        excerpt: "Connaître l'ennemi pour mieux le battre. Forces et faiblesses de chaque concurrent type.",
        content: `# Analyse Concurrentielle Approfondie
...
> "Avez-vous lu les conditions de résiliation ? Êtes-vous prêt à être engagé 2 ans ?"`,
    ...
    },
    {
        ...
        category: 'tools',
        excerpt: "Lexique complet des termes web à maîtriser : API, SEO, CMS, SSL, UX/UI et plus encore.",
        content: `# Glossaire Technique Approfondi
...
seedTrainingResources().catch(console.error);
