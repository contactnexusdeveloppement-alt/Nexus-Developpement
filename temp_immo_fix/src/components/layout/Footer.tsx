                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3 text-gray-300">
                            <li><a href="#" className="hover:text-gold transition-colors">Nos Biens à la Vente</a></li>
                            <li><a href="#" className="hover:text-gold transition-colors">Nos Locations</a></li>
                            <li><a href="#" className="hover:text-gold transition-colors">Estimer mon Bien</a></li>
                            <li><a href="#" className="hover:text-gold transition-colors">L'Agence</a></li>
